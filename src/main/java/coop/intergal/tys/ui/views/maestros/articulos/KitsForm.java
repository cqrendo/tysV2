...
/**
 * A Designer generated component for the kits-form template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("kits-form")
@JsModule("./src/views/Maestros/Articulos/kits-form.js")
public class KitsForm extends GenericDynamicForm implements BeforeEnterObserver {
	/**
	 * 
	 */
...
//	@Override
	public void setBinder(Binder<DynamicDBean> binder2) {
		...
		if (bean != null)
			binder.setBean(bean);
		bindFields(KitsForm.class, this);
    ...
    /**
     * This model binds properties between KitsForm and kits-form
     */
    public interface KitsFormModel extends TemplateModel {
