...
/**
 * A Designer generated component for the kits-copiar template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("kits-copiar")
@JsModule("./src/views/Maestros/Articulos/kits-copiar.js")
public class KitsCopiar extends GenericDynamicForm implements BeforeEnterObserver {
	/**
	 * 
	 */
...
//	@Override
	public void setBinder(Binder<DynamicDBean> binder2) {
		...
		if (bean != null)
			binder.setBean(bean);
		bindFields(KitsCopiar.class, this);
    ...
    /**
     * This model binds properties between KitsCopiar and kits-copiar
     */
    public interface KitsCopiarModel extends TemplateModel {
