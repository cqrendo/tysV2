...
/**
 * A Designer generated component for the fiscales-cmasivos template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("fiscales-cmasivos")
@JsModule("./src/views/Maestros/PersonasEntidades/fiscales-cmasivos.js")
public class FiscalesCmasivos extends GenericDynamicForm implements BeforeEnterObserver {
	/**
	 * 
	 */
    ...
    /**
     * Creates a new FiscalesCmasivos.
     */
    public FiscalesCmasivos() {
		super();
...
//	@Override
	public void setBinder(Binder<DynamicDBean> binder2) {
		...
		if (bean != null)
			binder.setBean(bean);
		bindFields(FiscalesCmasivos.class, this);
    ...
    /**
     * This model binds properties between FiscalesCmasivos and fiscales-cmasivos
     */
    public interface FiscalesCmasivosModel extends TemplateModel {
