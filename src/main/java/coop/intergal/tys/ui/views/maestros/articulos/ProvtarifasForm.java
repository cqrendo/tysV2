...
/**
 * A Designer generated component for the provtarifas-form template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("provtarifas-form")
@JsModule("./src/views/Maestros/Articulos/provtarifas-form.js")
public class ProvtarifasForm extends GenericDynamicForm implements BeforeEnterObserver {
	/**
	 * 
	 */
    ...
    /**
     * Creates a new ProvtarifasForm.
     */
    public ProvtarifasForm() {
		super();
...
//	@Override
	public void setBinder(Binder<DynamicDBean> binder2) {
		...
		if (bean != null)
			binder.setBean(bean);
		bindFields(ProvtarifasForm.class, this);
    ...
    /**
     * This model binds properties between ProvtarifasForm and provtarifas-form
     */
    public interface ProvtarifasFormModel extends TemplateModel {
