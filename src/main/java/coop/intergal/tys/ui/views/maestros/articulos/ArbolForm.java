...
/**
 * A Designer generated component for the arbol-form template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("arbol-form")
@JsModule("./src/views/Maestros/Articulos/arbol-form.js")
public class ArbolForm extends GenericDynamicForm implements BeforeEnterObserver {
	/**
	 * 
	 */
...
//	@Override
	public void setBinder(Binder<DynamicDBean> binder2) {
		...
		if (bean != null)
			binder.setBean(bean);
		bindFields(ArbolForm.class, this);
    ...
    /**
     * This model binds properties between ArbolForm and arbol-form
     */
    public interface ArbolFormModel extends TemplateModel {
