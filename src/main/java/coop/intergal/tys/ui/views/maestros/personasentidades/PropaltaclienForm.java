...
/**
 * A Designer generated component for the propaltaclien-form template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("propaltaclien-form")
@JsModule("./src/views/Maestros/PersonasEntidades/propaltaclien-form.js")
public class PropaltaclienForm extends GenericDynamicForm implements BeforeEnterObserver {
	/**
	 * 
	 */
    ...
    /**
     * Creates a new PropaltaclienForm.
     */
    public PropaltaclienForm() {
		super();
...
//	@Override
	public void setBinder(Binder<DynamicDBean> binder2) {
		...
		if (bean != null)
			binder.setBean(bean);
		bindFields(PropaltaclienForm.class, this);
    ...
    /**
     * This model binds properties between PropaltaclienForm and propaltaclien-form
     */
    public interface PropaltaclienFormModel extends TemplateModel {
