...
/**
 * A Designer generated component for the fiscales-form template.
 *
 * Designer will add and remove fields with @Id mappings but
 * does not overwrite or otherwise change this file.
 */
@Tag("fiscales-form")
@JsModule("./src/views/Maestros/PersonasEntidades/fiscales-form.js")
public class FiscalesForm extends GenericDynamicForm implements BeforeEnterObserver {
	/**
	 * 
	 */
...
//	@Override
	public void setBinder(Binder<DynamicDBean> binder2) {
		...
		if (bean != null)
			binder.setBean(bean);
		bindFields(FiscalesForm.class, this);
    ...
    /**
     * This model binds properties between FiscalesForm and fiscales-form
     */
    public interface FiscalesFormModel extends TemplateModel {
