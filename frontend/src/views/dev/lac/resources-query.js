...
class ResourcesQuery extends PolymerElement {
  static get template() {
    return html`
   <style>
      :host {
...
/* 		} */
   ...
   <vaadin-horizontal-layout theme="" style="width: 100%; height: 100%;"> 
    ...
    <div> 
     <div class="linCampos"> 
      <vaadin-text-field id="col1" label="Name" class="big"></vaadin-text-field> 
     </div> 
    </div> 
    <!-- </vaadin-form-item>  --> 
    <!--  <br class="clean"> --> 
...
window.customElements.define(ResourcesQuery.is, ResourcesQuery);
