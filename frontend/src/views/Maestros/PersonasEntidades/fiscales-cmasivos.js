 ...
 * `fiscales-cmasivos`
 *
 * FiscalesCmasivos element.
 *
 * @customElement
 * @polymer
 */
class FiscalesCmasivos extends PolymerElement {
...
customElements.define(FiscalesCmasivos.is, FiscalesCmasivos);
