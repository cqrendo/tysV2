 ...
 * `clientes-emparejar`
 *
 * ClientesEmparejar element.
 *
 * @customElement
 * @polymer
 */
class ClientesEmparejar extends PolymerElement {
...
customElements.define(ClientesEmparejar.is, ClientesEmparejar);
