 ...
 * `proveedores-ficha`
 *
 * ProveedoresFicha element.
 *
 * @customElement
 * @polymer
 */
class ProveedoresFicha extends PolymerElement {
...
customElements.define(ProveedoresFicha.is, ProveedoresFicha);
