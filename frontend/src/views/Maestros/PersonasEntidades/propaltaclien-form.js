 ...
 * `propaltaclien-form`
 *
 * PropaltaclienForm element.
 *
 * @customElement
 * @polymer
 */
class PropaltaclienForm extends PolymerElement {
...
customElements.define(PropaltaclienForm.is, PropaltaclienForm);
