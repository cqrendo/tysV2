...
class EntradaForm extends PolymerElement {
  static get template() {
    return html`
   <style>
      :host {
   ...
   <iron-pages selected="[[page]]">  
    <page> 
     ...
     <div class="linCampos"> 
      ...
      <vaadin-text-field id="col4" label="Nombre Proveedor" class="veryBig"></vaadin-text-field> 
      ...
      <vaadin-text-field id="col8" label="Nombre Comprador"></vaadin-text-field> 
     </div> 
    ...
    <page> 
     <div class="linCampos"> 
      <vaadin-text-field id="colxx" label="NumXXXX" maxlength="2" class="verySmall"></vaadin-text-field> 
     </div> 
    </page> 
   </iron-pages> 
`;
...
window.customElements.define(EntradaForm.is, EntradaForm);
