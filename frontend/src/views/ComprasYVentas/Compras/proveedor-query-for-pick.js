...
class ProveedorQueryForPick extends PolymerElement {
  static get template() {
    return html`
   <style>
      :host {
...
/* 		} */
   ...
   <!-- If you delete the following tag you get extrange error when you run the app --> 
   <vaadin-horizontal-layout theme="" style="width: 100%;"> 
    ...
    <div> 
     <div class="linCampos"> 
      <vaadin-text-field id="col1" label="Nombre Proveedor" class="big"></vaadin-text-field> 
     </div> 
    </div> 
    <!-- </vaadin-form-item>  --> 
    <!--  <br class="clean"> --> 
...
`;
  ...
  static get is() {
    return 'proveedor-query-for-pick';
  }
  ready() {
    super.ready();
...
window.customElements.define(ProveedorQueryForPick.is, ProveedorQueryForPick);
