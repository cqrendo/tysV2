...
class ArticulosQueryForPick extends PolymerElement {
  static get template() {
    return html`
   <style>
      :host {
...
/* 		} */
   ...
   <vaadin-horizontal-layout theme="" style="width: 100%; height: 100%;"> 
    ...
    <div> 
     <div class="linCampos"> 
      <vaadin-text-field id="col1" label="Descripción" class="big"></vaadin-text-field> 
     </div> 
    </div> 
    <!-- </vaadin-form-item>  --> 
    <!--  <br class="clean"> --> 
...
`;
  ...
  static get is() {
    return 'articulos-query-for-pick';
  }
  ready() {
    super.ready();
...
window.customElements.define(ArticulosQueryForPick.is, ArticulosQueryForPick);
